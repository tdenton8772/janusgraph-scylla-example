    ...
    def insert_product(self, product: Product) -> bool:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                VALUES (%(product_id)s, %(name)s, %(description)s, %(price)s, %(category)s, %(brand)s,
                        %(sku)s, %(stock_quantity)s, %(created_date)s, %(is_active)s)
                """
                ...
                VALUES (%(category)s, %(product_id)s, %(name)s, %(price)s, %(brand)s, %(created_date)s)
                """
    ...
    def insert_order(self, order: Order) -> bool:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                VALUES (%(order_id)s, %(user_id)s, %(order_date)s, %(status)s, %(total_amount)s,
                        %(shipping_address)s, %(payment_method)s)
                """
                ...
                VALUES (%(user_id)s, %(order_id)s, %(order_date)s, %(status)s, %(total_amount)s)
                """
    ...
    def insert_review(self, review: Review) -> bool:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                VALUES (%(product_id)s, %(review_id)s, %(user_id)s, %(rating)s, %(title)s, %(comment)s,
                        %(review_date)s, %(is_verified_purchase)s)
                """
                ...
                VALUES (%(user_id)s, %(review_id)s, %(product_id)s, %(rating)s, %(title)s, %(review_date)s)
                """
    ...
    def find_user_by_username(self, username: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                query = "SELECT * FROM users WHERE username = %(username)s ALLOW FILTERING"
    ...
    def get_user_orders(self, user_id: uuid.UUID, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                query = f"SELECT * FROM user_orders WHERE user_id = %(user_id)s LIMIT {limit}"
    ...
    def get_product_reviews(self, product_id: uuid.UUID, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                query = f"SELECT * FROM reviews WHERE product_id = %(product_id)s LIMIT {limit}"
    ...
    def get_products_by_category(self, category: str, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                query = f"SELECT * FROM products_by_category WHERE category = %(category)s LIMIT {limit}"
    ...
    def get_order_items(self, order_id: uuid.UUID) -> List[Dict[str, Any]]:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                query = "SELECT * FROM order_items WHERE order_id = %(order_id)s"
    ...
    def get_user_reviews(self, user_id: uuid.UUID, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                query = f"SELECT * FROM user_reviews WHERE user_id = %(user_id)s LIMIT {limit}"
                result = session.execute(query, {'user_id': user_id})
    ...
    def get_product_details_with_reviews(self, product_id: uuid.UUID) -> Dict[str, Any]:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                # Get product details
                product_query = "SELECT * FROM products WHERE product_id = %(product_id)s"
                product_result = session.execute(product_query, {'product_id': product_id})
                ...
                # Get product reviews
                reviews_query = "SELECT * FROM reviews WHERE product_id = %(product_id)s LIMIT 20"
                reviews_result = session.execute(reviews_query, {'product_id': product_id})
    ...
    def search_products_by_price_range(self, min_price: Decimal, max_price: Decimal, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                query = f"SELECT * FROM products WHERE price >= %(min_price)s AND price <= %(max_price)s ALLOW FILTERING LIMIT {limit}"
                result = session.execute(query, {'min_price': min_price, 'max_price': max_price})
    ...
    def get_order_summary_with_items(self, order_id: uuid.UUID) -> Dict[str, Any]:
        ...
        try:
            with db_manager.scylla.get_session() as session:
                ...
                # Get order details
                order_query = "SELECT * FROM orders WHERE order_id = %(order_id)s"
                order_result = session.execute(order_query, {'order_id': order_id})
                ...
                # Get order items
                items_query = "SELECT * FROM order_items WHERE order_id = %(order_id)s"
                items_result = session.execute(items_query, {'order_id': order_id})
                
                items = []
                for item_row in items_result:
                    # Get product details for each item
                    product_query = "SELECT name, price FROM products WHERE product_id = %(product_id)s"
                    product_result = session.execute(product_query, {'product_id': item_row.product_id})
                    product_row = product_result.one()
